        ...
        <v-card>
          ...
          <v-card-text>
            ...
            <h2 class="display-1">Happy Birthday
              <br><p class="green--text">Folorunso Odunola .R</p>
            </h2>

            <p class="body-2">
              I wish you get everything you desire <br>
            ...
            <p class="body-2 green--text">@Sunny Odibo</p>
          </v-card-text>
        </v-card>
      </v-flex>

      <v-flex xs12>
        <v-img :src="require('../assets/bday-112.gif')" contain height="200"></v-img>
      </v-flex>

      <v-flex xs12>
        <v-btn to="/" color="info">Back to Home</v-btn>
      </v-flex>
    </v-layout>
  </v-container>
</template>
